...
1. Cuando el usuario lo pida, generar la APK 0.2.3 y revisar visualmente el nombre, la terminologia plebeya, la confirmacion, los fuegos artificiales y el restablecimiento demo en un telefono.
...
- El APK existente queda desactualizado respecto del codigo 0.2.3 hasta que el usuario solicite expresamente un nuevo build.
