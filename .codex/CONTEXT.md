...
- Baseline verificado: 43 pruebas locales (42 puras más una integración con clips licenciados preparados), 100% de instrucciones/ramas/líneas/métodos del dominio y Android Lint sin observaciones. La integración de clips se omite explícitamente en CI público sin assets; no se descargan audios durante CI.
