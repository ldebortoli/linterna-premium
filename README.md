...
- Compra simulada, sin dinero ni tarjeta, en la variante `demoDebug`.
...
- Un telefono Android con flash para probar la funcion fisica. El emulador sirve para revisar la interfaz, pero normalmente no ofrece linterna.
...
El APK de prueba queda en `apps/mobile/android/app/build/outputs/apk/demo/debug/`. Para instalarlo con un telefono conectado y depuracion USB habilitada:
